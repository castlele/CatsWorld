...
extension View {
	...
	func volumetricShadows(color1: Color = .volumeEffectShadowColor, color2: Color = .shadowColor, radius: CGFloat = 5, isPressed: Bool = false, isInner: Bool = false) -> some View {
